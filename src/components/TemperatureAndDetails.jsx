...
function TemperatureAndDetails({weather:{
  ...
  return (
    <div>
      <div >
        <p className="flex items-center justify-center py-6 text-xl text-cyan-300">{details}</p>
      </div>
    ...
    <div className="flex flex-row items-center justify-between text-white py-3">
     ...
     <div className="flex flex-row items-center justify-center space-x-1 text-white text-sm py-3">
        ...
        <UilSunset />
        <p className="font-light">
             Set: <span className="font-medium ml-1">{formatToLocalTime(sunset, timezone, 'hh:mm a')}</span></p>
        <p className="font-light">|</p>   
